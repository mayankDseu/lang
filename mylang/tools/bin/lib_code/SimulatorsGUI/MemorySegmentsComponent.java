...
public class MemorySegmentsComponent extends JPanel {
   ...
   public MemorySegmentsComponent() {
      ...
      this.segmentsSplitPane5 = new JSplitPane(0, this.thatSegment, this.tempSegment);
      this.segmentsSplitPane4 = new JSplitPane(0, this.thisSegment, this.segmentsSplitPane5);
      this.segmentsSplitPane3 = new JSplitPane(0, this.argSegment, this.segmentsSplitPane4);
      this.segmentsSplitPane2 = new JSplitPane(0, this.localSegment, this.segmentsSplitPane3);
      this.segmentsSplitPane1 = new JSplitPane(0, this.staticSegment, this.segmentsSplitPane2);
