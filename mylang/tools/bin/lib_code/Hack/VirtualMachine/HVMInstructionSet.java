...
public class HVMInstructionSet {
   ...
   public byte instructionStringToCode(String var1) {
      Byte var2 = (Byte)this.instructionToCode.get(var1);
      return var2 != null ? var2 : -99;
   }

   public String instructionCodeToString(byte var1) {
      return (String)this.instructionToString.get(new Byte(var1));
   }

   public boolean isLegalVMSegment(String var1) {
      return this.segmentCodes.get(var1) != null;
   }

   public byte segmentVMStringToCode(String var1) {
      Byte var2 = (Byte)this.segmentCodes.get(var1);
      return var2 != null ? var2 : -1;
   }

   public String segmentStringVMToPointer(String var1) {
      return (String)this.segmentPointerStrings.get(var1);
   }

   public String segmentCodeToVMString(byte var1) {
      return (String)this.segmentStrings.get(new Byte(var1));
   }
}
