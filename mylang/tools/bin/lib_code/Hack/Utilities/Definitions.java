...
public class Definitions {
   ...
   public static short computeALU(short var0, short var1, boolean var2, boolean var3, boolean var4, boolean var5, boolean var6, boolean var7) {
      if (var2) {
         var0 = 0;
      }
   ...
   public short getKeyCode(KeyEvent var1) {
      boolean var2 = false;
      char var3 = var1.getKeyChar();
      short var4 = (short)var1.getKeyCode();
      short var5;
      if (var3 == '\uffff') {
         var5 = this.actionKeyCodes[var4];
   ...
   public String getKeyName(KeyEvent var1) {
      String var2 = KeyEvent.getKeyModifiersText(var1.getModifiers());
      String var3 = var2 + (var2.length() > 0 ? "+" : "") + KeyEvent.getKeyText(var1.getKeyCode());
      return var3;
   }
